...
import { Loader2, XCircle, Youtube, X, Linkedin, Rss } from 'lucide-react';
...
export const SmartUrlInput = React.forwardRef<
  HTMLInputElement,
  SmartUrlInputProps
>(
  (
    ...
    const detectPlatform = useCallback(
      (url: string) => {
        ...
        try {
          ...
          const error =
            err instanceof Error ? err : new Error('Platform detection failed');
    ...
    const debouncedDetectPlatform = useCallback(
      (url: string) => {
        if (debounceTimer) {
