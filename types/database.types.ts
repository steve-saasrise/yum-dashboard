  ...
  public: {
    Tables: {
      ...
      content_processing_queue: {
        ...
        Insert: {
          ...
          started_at?: string | null;
          status?:
            | Database['public']['Enums']['processing_queue_status']
            | null;
          updated_at?: string | null;
        };
        Update: {
      ...
      daily_news_summaries: {
        Row: {
          ...
          special_section: Json | null;
          summary_bullets: Json;
          token_count: number | null;
          topic: string;
          updated_at: string | null;
          used_in_digest: boolean | null;
        };
        Insert: {
          created_at?: string | null;
          generated_at?: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: 'daily_news_summaries_lounge_id_fkey';
            columns: ['lounge_id'];
            isOneToOne: false;
            referencedRelation: 'lounges';
            referencedColumns: ['id'];
    ...
    Functions: {
      ...
      get_all_deleted_content_ids: {
        Args: { excluded_creator_ids?: string[] };
        Returns: {
          content_id: string;
        }[];
      };
